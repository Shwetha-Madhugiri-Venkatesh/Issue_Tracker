...
import { GridListItem, GridsterComponent, IGridsterOptions } from '@hyperviewhq/angular2gridster';
...
export class DashboardHomeComponent {
  ...
  item1={w:2,h:2,x:0,y:0};
  item2={w:2,h:2,x:2,y:0};
  ...
  ngOnInit(){
    ...
    this.two_way.current_dashboard_subcomponent("");
